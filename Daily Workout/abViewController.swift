...
class abViewController: UIViewController
{
    ...
    {
        let path = NSBundle.mainBundle().pathForResource("ab exercise for men", ofType: ".mp4")
    ...
    {
        let path = NSBundle.mainBundle().pathForResource("ab exercise for men 1", ofType: ".mp4")
        let url = NSURL(fileURLWithPath: path!)
        video = AVPlayer(URL: url)
        videoplayer.player = video
        self.presentViewController(videoplayer, animated:true)
    ...
    {
        let path = NSBundle.mainBundle().pathForResource("ab exercise for women", ofType: ".mp4")
        let url = NSURL(fileURLWithPath: path!)
        video = AVPlayer(URL: url)
        videoplayer.player = video
        self.presentViewController(videoplayer, animated:true)
    ...
    {
        let path = NSBundle.mainBundle().pathForResource("ab exercise for women 1", ofType: ".mp4")
        let url = NSURL(fileURLWithPath: path!)
        video = AVPlayer(URL: url)
        videoplayer.player = video
        self.presentViewController(videoplayer, animated:true)
